...
using Sistema.Entity.Models;

//cambiamos Sistema.Entity.Models; por nombre de carpetas (Sistema.DALL.DBContext) 
...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C574E4CC3");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F7898A9C7");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483ED5ED2D5");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1076A97A858");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E2CFC5257");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132D275AA8A");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F764C23FF55");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8D029FFBD");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE3288A02A");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6F7D7AD2A");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56142E94C5C5");
